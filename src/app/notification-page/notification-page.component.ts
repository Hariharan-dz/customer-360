...
export class NotificationPageComponent implements OnInit {
    ...
    buildData: (notification: any) => {
      return notification.map((notification: any) => {
        ...
        return {
          ...
          link: {
            id: notification.is_processed ? '/notifications/' + notification.id + '/history' : '/notifications/' + notification.id
          },
          action: {
            view: '/notifications/' + notification.id + '/history',
            edit: '/notifications/' + notification.id,
            clone: '/notifications/clone/' + notification.id,
          }
        };
      });
    }
  ...
  constructor(private datePipe: DatePipe, public notifiService: NotificationUiService,
    private alertController: AlertController, public loadingCtrl: LoadingController) {
