    ...
    buildData: (sentNotification: any) => {
      return sentNotification.map((sentNotification: any) => {
        ...
        return {
          ...
          link: {
            notification_id: sentNotification.is_ab_testing ? '/notifications/ab-testing/result/' + sentNotification.notification_id : '/notifications/' + sentNotification.notification_id + '/history'
          },
          action: {}
        };
      });
    ...
    buildData: (submitdefer: any) => {
      return submitdefer.map((submitdefer: any) => {
        ...
        return {
          ...
          link: {
            notification_id: submitdefer.is_ab_testing ? '/notifications/ab-testing/result/' + submitdefer.notification_id : '/notifications/' + submitdefer.notification_id + '/history'
          },
          action: {
    ...
    buildData: (deliveredNotification: any) => {
      return deliveredNotification.map((deliveredNotification: any) => {
        ...
        return {
          ...
          link: {
            notification_id: deliveredNotification.is_ab_testing ? '/notifications/ab-testing/result/' + deliveredNotification.notification_id : '/notifications/' + deliveredNotification.notification_id + '/history'
          },
          action: {
